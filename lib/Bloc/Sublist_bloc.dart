...
class sublist_Bloc{
  ...
  final _manufacFetcher = PublishSubject<List<ManufactureModel>>(); //TODO::MODEL chng kora lagbe
  ...
  final _CreatePropductSuccessFetcher = PublishSubject<sublist_getsuccess_model>();
  final _UpdatePropductSuccessFetcher = PublishSubject<sublist_getsuccess_model>();
  Stream<sublist_getsuccess_model> get CreatePropductSuccessFetcher => _CreatePropductSuccessFetcher.stream;
  Stream<sublist_getsuccess_model> get UpdatePropductSuccessFetcher => _UpdatePropductSuccessFetcher.stream;

  //sublist_Create_get_success_sink
  final _unitSuccessFetcher = PublishSubject<sublist_getsuccess_model>();
  final _manufacSuccessFetcher = PublishSubject<sublist_getsuccess_model>(); //TODO::MODEL chng kora lagbe
  ...
  final _materialpackSuccessFetcher = PublishSubject<sublist_getsuccess_model>();


  //sublist_Create_get_success_sink
  final _unitUpdateSuccessFetcher = PublishSubject<sublist_getsuccess_model>();
  final _manufacUpdateSuccessFetcher = PublishSubject<sublist_getsuccess_model>(); //TODO::MODEL chng kora lagbe
  final _catagoryUpdateSuccessFetcher = PublishSubject<sublist_getsuccess_model>();
  final _subcatagoryUpdateSuccessFetcher = PublishSubject<sublist_getsuccess_model>();
  final _materialpackUpdateSuccessFetcher = PublishSubject<sublist_getsuccess_model>();
  ...
  Stream<List<SubCategoryModel>> get allsubcategory => _subcatagoryFetcher.stream;
  Stream<List<MaterialPackModel>> get allmaterialpack => _materialpackFetcher.stream;


  Stream<sublist_getsuccess_model> get allUnitSuccessData => _unitSuccessFetcher.stream;
  Stream<sublist_getsuccess_model> get allmanufacSuccess => _manufacSuccessFetcher.stream;
  Stream<sublist_getsuccess_model> get allcategorySuccess => _catagorySuccessFetcher.stream;
  Stream<sublist_getsuccess_model> get allsubcategorySuccess => _subcatagorySuccessFetcher.stream;
  Stream<sublist_getsuccess_model> get allmaterialpackSuccess => _materialpackSuccessFetcher.stream;
...
//getunit_id
  ...
  fetchAllSubCatagoryData() async {
    ...
    List<SubCategoryModel> subcategorydata = await _repository.getAllSubCategoryData();
  ...
  fetchAllMateralPackData() async {
    ...
    List<MaterialPackModel> materialpackdata = await _repository.getAllMaterialPackData();
  ...
  createunit() async{
    ...
    sublist_getsuccess_model success = await _repository.createUnit(_unit.value, _unitshort.value);
  ...
  createpackagingmaterial() async{
    print("data:: "+_packaging_material.value+" "+_packaging_material.value);
    sublist_getsuccess_model success = await _repository.createPackagingMaterial(_packaging_material.value);
    //_repository.createPost(_name.value, _posts.value);
  ...
  createcategory() async{
    ...
    sublist_getsuccess_model success = await _repository.createCategory(_category.value);
    //_repository.createPost(_name.value, _posts.value);
  ...
  createsubcategory() async{
    ...
    sublist_getsuccess_model success = await _repository.createSubCategory(_category_id.value,_sub_category.value);
    //_repository.createPost(_name.value, _posts.value);
  ...
  createProductMasterData() async{
    print("CatagoryID: "+_Category.value+" SubID: "+_SubCategory.value+" UnitID: "+_UnitList.value+" ManuID: "+_Manufacturer.value+
    ...
    sublist_getsuccess_model success = await _repository.createProductMasterData(_ProductName.value,_ProductDescription.value,_Category.value,_SubCategory.value,_UnitList.value,_Manufacturer.value,
  ...
  UpdateProductMasterData() async{
    ...
    sublist_getsuccess_model success = await _repository.updateProductMasterData(_product_id.value,_ProductName.value,_ProductDescription.value,_Category.value,_SubCategory.value,_UnitList.value,_Manufacturer.value,
        _Manufacturer_Pn.value,_Gtin.value,_ListPrice.value);
